...
protected:
  ...
  // virtual void PyInt_INSERT(std::string_view name, const py::int_ &number) =
  // 0; virtual void PyFloat_INSERT(std::string_view name,
  ...
  // virtual py::int_ PyInt_GET(std::string_view name) = 0;
